...
export var WatchRequest = {
    ...
    create: function (base) {
        return WatchRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
export var WatchResponse = {
    ...
    create: function (base) {
        return WatchResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseWatchResponse();
...
export var WatchEvent = {
    ...
    create: function (base) {
        return WatchEvent.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseWatchEvent();
...
export var UnWatchRequest = {
    ...
    create: function (base) {
        return UnWatchRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseUnWatchRequest();
...
export var UnWatchResponse = {
    ...
    create: function (base) {
        return UnWatchResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
